...
void UnitTest() {
  ...
  str_yours = sserr.str();
  Test(str_yours == no_value, "GetElement(0) - Error Message", str_yours, no_value);

  int_actual = 0;
  Test(value == int_actual, "GetElement(0)", value, int_actual);
  sserr.str("");
  
  value = my_list.GetElement(-1);
  str_yours = sserr.str();
  Test(str_yours == no_value, "GetElement(-1) - Error Message", str_yours, no_value);

  int_actual = 0;
  Test(value == int_actual, "GetElement(-1)", value, int_actual);
  sserr.str("");
  ...
  dbl_yours = my_list.GetElement(3);
  int_actual = 5.5;
  Test(dbl_yours == 5.5, "GetElement(3)", dbl_yours, 5.5);
